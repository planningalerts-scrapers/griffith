...
switch(getenv('MORPH_PERIOD')) {
    case 'thismonth' :
        ...
        break;
    case 'lastmonth' :
        $sdate = date('d/m/Y', strtotime('first day of previous month'));
        $edate = date('d/m/Y', strtotime('last day of previous month'));
        break;
    default          :
...
$url_base     = "https://datracking.griffith.nsw.gov.au";
$comment_base = "mailto:admin@griffith.nsw.gov.au";
 ...
 * Note: $junk has been modified to download 100 records - Server is pretty slow!
 */
